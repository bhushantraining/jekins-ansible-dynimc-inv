  ...
  stages {
    ...
    stage('RunPlaybook') {
      steps {
        ...
        sh "ansible-playbook -i playbooks/tomcat-setup.yaml -u ec2-user --private-key=$AWS_EC2_PRIVATE_KEY --limit tomcatservers --ssh-common-args='-o StrictHostKeyChecking=no'"
      }
    }
